...
export default function LocaleError({ reset }: { error: Error & { digest?: string }; reset: () => void }) {
  ...
  return (
    <section className="hero-canvas flex min-h-[70svh] flex-col items-center justify-center px-4 pt-24 text-center">
      ...
      <h1 className="font-display mt-4 text-3xl font-semibold t-fg sm:text-4xl">
      ...
      <button
        type="button"
        onClick={() => reset()}
        className="mt-8 inline-flex min-h-11 items-center rounded-md bg-gold-bright px-6 py-3 text-sm font-semibold text-obsidian hover:bg-gold-bright"
      >
