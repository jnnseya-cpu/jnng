  ...
  },
  {
    ...
    body: {
      en: [
        ...
        "KODA exists to make that question instant. It verifies mobile money payments through five doors onto one engine: a Manual Console for the market trader (type the reference, get a real answer), WhatsApp Chat Mode for the informal merchant (verification joins the chat where the sale happens), an API for platforms and retailers who need verification inside their own checkout, USSD for any handset — no smartphone, no app, no data — and Inbound SMS, where forwarding the operator's payment SMS verifies it automatically. Same engine, whatever your size and whatever your phone.",
      ...
      fr: [
        ...
        "KODA existe pour rendre cette question instantanée. Il vérifie les paiements mobile money par cinq portes sur un seul moteur : une console manuelle pour le commerçant du marché (tapez la référence, obtenez une vraie réponse), un mode WhatsApp pour le marchand informel (la vérification rejoint la conversation où se fait la vente), une API pour les plateformes et détaillants qui veulent la vérification dans leur propre parcours de paiement, l'USSD pour n'importe quel téléphone — sans smartphone, sans application, sans données — et le SMS entrant, où transférer le SMS de l'opérateur vérifie le paiement automatiquement. Le même moteur, quelle que soit votre taille et quel que soit votre téléphone.",
...
articles.push(
  ...
  },
  {
    ...
    category: { en: "Features", fr: "Fonctionnalités" },
    title: {
      en: "Console, WhatsApp, API, USSD or SMS: which KODA door fits your business",
      fr: "Console, WhatsApp, API, USSD ou SMS : quelle porte KODA convient à votre activité",
    },
    excerpt: {
      en: "KODA verifies mobile money payments through five interfaces on one engine. Here is what each mode does, who it is for, and how to choose — from market stall to national platform, on any phone.",
      fr: "KODA vérifie les paiements mobile money par cinq interfaces sur un seul moteur. Voici ce que fait chaque mode, à qui il s'adresse, et comment choisir — de l'étal de marché à la plateforme nationale, sur n'importe quel téléphone.",
    },
    body: {
      en: [
        "One verification engine, five doors — because a market trader, a boutique owner and a platform engineer should not be forced through the same interface. Every KODA mode answers the same question with the same authority: did this payment really arrive, from this number, now?",
        ...
        "API Mode is for platforms, retailers and billers who need verification inside their own checkout: a clean developer interface that confirms mobile money payments programmatically, with webhooks for reconciliation and fraud flags. The same engine that protects a street vendor protects a national retail chain — that is the five-door architecture, and each new mobile money operator integrated strengthens every door at once.",
        "The last two doors need no smartphone at all. USSD Mode works on the most basic handset in the market: dial a KODA shortcode, key in the code, and the verdict comes back on-screen and by SMS — no app, no data. Inbound SMS is the hands-free door: forward (or auto-forward) the operator's payment SMS to KODA and it verifies automatically the moment it lands, on any device. Every door feeds the same replay lock, fraud scoring and merchant ledger — a code verified at one door is dead to all the others.",
      ...
      fr: [
        "Un moteur de vérification, cinq portes — parce qu'un vendeur de marché, une patronne de boutique et un ingénieur de plateforme ne devraient pas être forcés de passer par la même interface. Chaque mode KODA répond à la même question avec la même autorité : ce paiement est-il vraiment arrivé, depuis ce numéro, maintenant ?",
        ...
        "Le mode API est fait pour les plateformes, détaillants et facturiers qui veulent la vérification dans leur propre parcours de paiement : une interface développeur propre qui confirme les paiements mobile money par programme, avec webhooks pour le rapprochement et les alertes de fraude. Le même moteur qui protège un vendeur de rue protège une chaîne nationale — c'est l'architecture à cinq portes, et chaque nouvel opérateur mobile money intégré renforce toutes les portes à la fois.",
        "Les deux dernières portes n'exigent aucun smartphone. Le mode USSD fonctionne sur le téléphone le plus basique du marché : composez un code court KODA, saisissez la référence, et le verdict revient à l'écran et par SMS — sans application, sans data. Le SMS entrant est la porte mains libres : transférez (ou auto-transférez) le SMS de paiement de l'opérateur à KODA et la vérification se fait automatiquement dès qu'il arrive, sur n'importe quel appareil. Chaque porte alimente le même verrou anti-rejeu, le même score de fraude et le même registre commerçant — un code vérifié à une porte est mort pour toutes les autres.",
