...
const articleSlugs = ["next-billion-users","one-shared-spine","governance-is-the-product","diaspora-corridor-economy","london-kinshasa-flights-guide","verify-mobile-money-payment","food-delivery-kinshasa","marketwar-ai-marketing-tools","veryx-audit-trail-governance","studyear-personalisation-engine","koda-three-doors","axionos-escrow-hiring-builders","3jn-travel-instalments-seat-holding"];
const allPaths = [];
...
// ---------- 5. PLATFORM DIRECTORY: filters, search, URL sync ----------
{
  ...
  if ((await cards()) === 22) ok("status filter: coming-soon = 22"); else fail("status filter", `${await cards()}`);
